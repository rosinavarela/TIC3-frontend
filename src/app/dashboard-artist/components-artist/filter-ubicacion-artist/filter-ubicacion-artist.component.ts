...
@Component({
  selector: 'app-filter-ubicacion-artist',
  templateUrl: 'filter-ubicacion-artist.component.html',
  styleUrls: ['filter-ubicacion-artist.component.css'],
  standalone: true,
  imports: [
    FormsModule,
    MatFormFieldModule,
...
export class FilterUbicacionArtistComponent implements OnInit {
